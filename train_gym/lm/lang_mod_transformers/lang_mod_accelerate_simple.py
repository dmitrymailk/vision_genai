...
#                 mixed_precision="bf16",  # Убираем, используем настройки по умолчанию
#                 # dataloader_config=dataloader_config,
#                 gradient_accumulation_steps=training_args.gradient_accumulation_steps,
#                 # **accelerator_log_kwargs,  # Убираем для максимальной близости к Trainer
#             )
...
#     # training_args.gradient_checkpointing = True  # Убираем, может увеличивать память
...
#             ],
#             "weight_decay": training_args.weight_decay,  # Используем правильное значение из training_args
#         },
#         {
#             "params": [
#                 p
...
#             max_train_steps
#         ),  # Используем правильные warmup steps
