...
# train configs
hf_train_config=./configs/llama3.2-1B.yaml

# start training
accelerate launch --config_file $config_path -m train_gym.massive_train.pretrain_edu.pretrain_hf_trainer $hf_train_config