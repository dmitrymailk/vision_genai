        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(unet):
                ...
                if args.snr_gamma is None:
                    ...
                    # FasterDiT: Towards Faster Diffusion Transformers Training without Architecture Modification https://arxiv.org/pdf/2410.10356
                    # Efficient Diffusion Training via Min-SNR Weighting Strategy https://arxiv.org/pdf/2303.09556
                    # ускорение сходимости от 3 до 7 раз как они пишут
